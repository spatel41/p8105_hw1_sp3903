...
When converting the vec_char variable to numberic, there is a NA's introduced by coercion warning message. 
* This provides context to what happens when you take the mean of a non-numberic vector. 
